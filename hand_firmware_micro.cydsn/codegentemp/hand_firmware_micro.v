...
module top ;
	...
	wire [0:0] tmpFB_0__Signal_1_C_net;
	...
	cy_psoc3_pins_v1_10
		...
		Signal_1_C
		 (.oe(tmpOE__Signal_1_C_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Signal_1_C_net[0:0]}),
    ...
    assign Net_3984 = Net_3960 | Net_3961;
	...
	cy_psoc3_pins_v1_10
		#(.id("08b05f5c-411e-42b2-9a6a-ea7506d26d71"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
