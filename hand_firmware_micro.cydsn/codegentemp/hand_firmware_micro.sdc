...
# Date: Fri, 20 Apr 2018 07:52:49 GMT
#set_units -time ns
...
create_generated_clock -name {CLOCK_ENCODERS} -source [get_pins {ClockBlock/clk_sync}] -edges {1 241 481} [list [get_pins {ClockBlock/dclk_glb_4}]]
...
create_generated_clock -name {CLOCK_PWM_1} -source [get_pins {ClockBlock/clk_sync}] -edges {1 96001 192001} [list [get_pins {ClockBlock/dclk_glb_5}]]
